  ...
  return (
    <DashboardLayout>
      <Hero
        ...
        subtitle="Search and connect with mentors to manage student counseling and guidance"
        alignment="center"
        background="cream"
      />
              ...
              {viewMode === 'grid' && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  >
                    ...
                    {/* View Details Arrow */}
                    <div className="mt-4 pt-4 border-t border-neutral-200 flex items-center justify-end text-brand-green font-medium text-sm">
                      View Details
                      <svg
