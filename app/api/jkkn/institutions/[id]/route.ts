...
/**
 * GET /api/jkkn/institutions/[id]
 * Fetch single institution from JKKN API (server-side with secure API key)
 */
export async function GET(
  ...
  try {
    ...
    // Call JKKN API
    const url = `${baseUrl}/api-management/organizations/institutions/${institutionId}`;
