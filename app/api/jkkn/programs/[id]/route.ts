...
/**
 * GET /api/jkkn/programs/[id]
 * Fetch single program from JKKN API (server-side with secure API key)
 */
export async function GET(
  ...
  try {
    ...
    // Call JKKN API
    const url = `${baseUrl}/api-management/organizations/programs/${programId}`;
